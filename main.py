    ...
    try:
        ...
        :return: Null
            ...
            try:
                ...
                Notification(title="An error occured",description="there is an error, you don't have the assets folder or forgot to change the path",duration=5,urgency='normal').send()
        ...
        """
            while True:
                try:
                    ...
                    Notification(title="An error occured",description='there are some issues while connecting to the server, the client will disconnect soon.',duration=5,urgency='normal').send()
                    client.close()
                    break
        ...
        """
            try:
                ...
                Notification(title="An error occured",description='there are some issues while connecting to the database.',duration=5,urgency='normal').send()
        ...
        """
            try:
                ...
                Notification(title="An error occured",description="Check on your own",duration=5,urgency='normal').send()
        ...
        """
            ...
            self.color_black=Button(self.settings,bg='black',width=5,height=2,command= lambda: self.change_color_window('black'))
            self.color_black.place(rely=0.1)
            self.color_white=Button(self.settings,bg='white',width=5,height=2,command= lambda: self.change_color_window('white'))
            self.color_white.place(rely=0.3)
            self.color_red=Button(self.settings,bg='red',width=5,height=2,command= lambda: self.change_color_window('red'))
            self.color_red.place(rely=0.5)
            self.color_orange=Button(self.settings,bg='orange',width=5,height=2,command= lambda: self.change_color_window('orange'))
            self.color_orange.place(relx=0.2,rely=0.1)
            self.color_blue=Button(self.settings,bg='blue',width=5,height=2,command= lambda: self.change_color_window('blue'))
            self.color_blue.place(relx=0.2,rely=0.3)
            self.color_yellow=Button(self.settings,bg='yellow',width=5,height=2,command= lambda: self.change_color_window('yellow'))
            self.color_yellow.place(relx=0.2,rely=0.5)
            self.color_unknown=Button(self.settings,bg='#58D68D',width=5,height=2,command= lambda: self.change_color_window('#58D68D'))
            self.color_unknown.place(relx=0.4,rely=0.1)
            self.color_unknown2=Button(self.settings,bg='#A569BD',width=5,height=2,command= lambda: self.change_color_window('#A569BD'))
        ...
        Notification(title="An error ocurred")
